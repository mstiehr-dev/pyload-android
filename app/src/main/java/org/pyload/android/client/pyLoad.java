...
public class pyLoad extends FragmentTabsPager
{
    ...
    protected void onNewIntent (Intent intent)
    {
        ...
        if (null != intent && "SHOW_QUEUE".equals(intent.getAction()))
        {
            // TODO: 12.04.2016 show queue fragment  
//            Fragment frag = getSupportFragmentManager().getFragments().get(1);
//            getSupportFragmentManager().beginTransaction().replace(R.id.pager, frag).commit();
        }
        else
        {
